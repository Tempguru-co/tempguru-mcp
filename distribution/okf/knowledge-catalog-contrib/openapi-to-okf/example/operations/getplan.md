...
resource: "https://mcp.tempguru.co/api/v1/plans/{id}"
...
- **Operation:** `GET https://mcp.tempguru.co/api/v1/plans/{id}`
- **Tags:** Planning
## Parameters

- `id` (path, required): 12-character plan ID returned by plan_staffing or save_staffing_plan.
