...
- [Published booking and procurement policies](getpolicies.md), `GET /api/v1/policies`
- [Restore a saved staffing plan](getplan.md), `GET /api/v1/plans/{id}`
- [Submit a staffing quote request (the API's only write operation)](submitquoterequest.md), `POST /api/v1/quote-requests`
- [Check quote-request receipt status](getquotestatus.md), `GET /api/v1/quote-requests/{reference}`
