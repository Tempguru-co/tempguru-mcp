...
the canonical skill changes. Version 1.0.3 adds the attributed Hermes endpoint,
the current 11-tool inventory, and quote-source fields; re-sync both files to
