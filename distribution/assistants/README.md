...
| Pi + Prime Agent (`tempguru-pi` npm package) | Agent Skill + native tools | ✅ `1.7.0` published 2026-08-07 with 8 runtime-adapted skills, 9 native tools, a non-PII buyer-form handoff, and automatic `pi` / `prime-agent` attribution; fresh official Prime v0.7.0 npm-artifact smoke passed |
