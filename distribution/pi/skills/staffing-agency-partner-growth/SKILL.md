...
| Tool | Use it to |
|---|---|
| `tempguru_get_cities` | Match the agency's service area against configured market entries and inspect the tier; the coordinator separately confirms partner fit and order coverage |
