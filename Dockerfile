...
LABEL org.opencontainers.image.description="MCP server for W-2 event staffing planning across 300+ U.S. and Canadian markets, backed by 5,000+ events and 100,000+ completed shifts; catalog matches require coordinator order confirmation. Twelve tools: plan_staffing, save_staffing_plan, get_plan, get_cities, get_roles, check_availability, get_role_pricing, get_compliance_by_state, get_policies, get_rate_benchmark, get_quote_status, request_quote."
